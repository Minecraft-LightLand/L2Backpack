...
public class LBLang {
	...
	public enum Info {
		...
		SCABBARD_INFO("tooltip.info.tool_bag", "Put in off hand or chest slot (or back slot of Curios).  Hold tools or weapons in main hand and press [%1$s] to preview, choose, and swap tools from scabbard. Press up/down or number to switch tools.", L2Keys.SHIFT),
		ARMORBAG_INFO("tooltip.info.armor_bag", "Put in off hand or chest slot (or back slot of Curios). Hold nothing in main hand and press [%1$s] to preview, choose, and swap armors. Press up/down or number to switch armors.", L2Keys.SHIFT),
