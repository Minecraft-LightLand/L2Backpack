...
public class GUIGenerator {
	...
	public static void main(String[] args) throws Exception {
		new GUIGenerator("l2backpack").gen();
	}
	...
	void gen() throws IOException {
		...
		for (File fi : f.listFiles()) {
			...
			var cont = e.get("isContainer");
			boolean isCont = cont == null || cont.getAsBoolean();
			Item bottom = ITEM_MAP.get(isCont ? "bottom" : "bottom_screen");
